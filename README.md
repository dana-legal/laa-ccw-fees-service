...
This service calculates legal aid fees for Controlled Work cases based on location, case stage, matter codes, and various fee types.

### Documentation
- **[Fee Types and Calculation Guide](FEE_TYPES.md)** - Detailed explanation of how different fee types work and how fees are calculated
